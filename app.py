...
def predict(file: UploadFile = File(...)):
    try:
        # Generate unique filename to avoid conflicts in concurrent requests
        unique_id = str(uuid.uuid4())
        
        # Step 1: Save uploaded file with a unique name
        os.makedirs(folder_path, exist_ok=True)
        ...
        segment_fish_u2net(input_path, output_folder)
